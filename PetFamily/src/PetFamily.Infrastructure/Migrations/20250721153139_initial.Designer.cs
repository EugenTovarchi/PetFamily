...
namespace PetFamily.Infrastructure.Migrations
{
    ...
    [Migration("20250721153139_initial")]
                    ...
                    b.OwnsMany("PetFamily.Domain.Requsites.Requisites", "PetRequisites", b1 =>
                        {
                            ...
                            b1.ToJson("PetRequisites");

                            b1.WithOwner()
                                .HasForeignKey("PetId");
                        });

                    b.OwnsOne("PetFamily.Domain.Pets.PetAddress", "PetAddress", b1 =>
                        {
                            b1.Property<Guid>("PetId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PetFamily.Domain.Volunteers.Volunteer", b =>
                {
                    ...
                    b.OwnsOne("VolunteerFullName", "VolunteerFullName", b1 =>
                        {
                            b1.Property<Guid>("VolunteerId")
                                .HasColumnType("uuid");
